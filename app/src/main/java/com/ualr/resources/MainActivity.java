...
public class MainActivity extends AppCompatActivity {
    ...
    public void onLessonLearntClicked(View view) {
        ...
        // TODO 5: DONNEE Get congrats_text resource -->
        congratsMessage = getString(R.string.congrats_text);
        // TODO 6: DONEEE  Once congratsMessage is initialized, uncomment the two following lines
